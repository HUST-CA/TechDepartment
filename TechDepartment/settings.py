"""
Django settings for TechDepartment project.
...
SECRET_KEY = '_n0*n(^e)!%@ff%t^&yci(ruk_a+*yze($^=f-olzae-fr#2&d'
...
ROOT_URLCONF = 'TechDepartment.urls'
...
WSGI_APPLICATION = 'TechDepartment.wsgi.application'
